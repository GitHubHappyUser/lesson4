...
public class HomeWork {
    ...
    public static void main(String[] args) {
         ...
         * Соответственно, класс Student и Course отвечают за описание соответствующих сущностей, класс HomeWorkData
    ...
    public static List<Course> getUnicsCourses(List<Student> students) {
        return students.stream() // Создаем стрим
                .flatMap(student -> student.getAllCourses().stream()) // Из списка студентов вытаскиваем списки курсов в один список и дальше продолжаем стрим по ним
